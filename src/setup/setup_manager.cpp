...
String SetupManager::setupStateToString(SetupState state) const {
  switch(state) {
    ...
    case SETUP_WIFI_CONFIG: return "WIFI_CONFIG";
    case SETUP_WIFI_TESTING: return "WIFI_TESTING";
    case SETUP_WIFI_FAILED: return "WIFI_FAILED";
    case SETUP_MQTT_CONFIG: return "MQTT_CONFIG";
    case SETUP_MQTT_TESTING: return "MQTT_TESTING";
    case SETUP_MQTT_FAILED: return "MQTT_FAILED";
    case SETUP_CONFIRMATION: return "CONFIRMATION";
...
String SetupManager::operationalStateToString(OperationalState state) const {
  switch(state) {
    case OPERATIONAL_NORMAL: return "NORMAL";
    case OPERATIONAL_WIFI_ERROR: return "WIFI_ERROR";
    case OPERATIONAL_MQTT_ERROR: return "MQTT_ERROR";
    case OPERATIONAL_ROLLBACK: return "ROLLBACK";
    default: return "UNKNOWN";
  }
}
